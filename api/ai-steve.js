...
function systemPrompt(locale) {
  ...
  return [
    ...
    '- Evidence, a clarifying question, and a next step do not stack. Sixty words holds the answer plus ONE of them — pick whichever the moment calls for and drop the others.',
    '',
